...
class BrandColors{
  ...
  static const Color colorOrange = Color(0xFFFF8900);
  ...
  static const Color colorYellow = Color.fromARGB(255, 255, 212, 40);
  static const Color colorBlack = Colors.black;
  static const Color colorGray = Color.fromARGB(255, 148, 147, 152);
  //static const Color colorDarkYellow = Color.fromARGB( 255, 255, 137, 0);
  //Color.fromARGB(255, 255, 212, 40)
